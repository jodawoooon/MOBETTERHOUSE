        ...
        <div class="col-12 col-xl-8">
              ...
              <div class="row">
                <div class="col-md-12 mb-3">
                  <div class="form-group">
                    ...
                    <input
                      :value="this.$store.state.userInfo.userEmail"
                      class="form-control"
                      id="userEmail"
                      type="email"
              ...
              <div class="row">
                ...
                <div class="col-md-6 mb-3">
                  <div class="form-group">
                    ...
                    <input
                      :value="this.$store.state.userInfo.userRank"
                      v-on:input="updateRank"
                      class="form-control"
                      id="userRank"
                      type="text"
                      readonly
              ...
              <div class="row">
                <div class="col-sm-12 mb-3">
                  <div class="form-group">
                    ...
                    <textarea
                      :value="this.$store.state.userInfo.userMessage"
          ...
          <div class="card-body">
            <div class="row">
              <div class="form-group">
                <div class="btn-group " style="float:right;">
                  <button type="submit" @click="showDeleteModal" class="btn btn-outline-danger">
