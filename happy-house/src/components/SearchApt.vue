  ...
  <main class="content">
    <div class="main bg-light p-4">
      ...
      <div class="row mb-3">
        <div class="col-3"></div>
        <div class="col-4">
          <input type="text" v-model="searchWord" @keypress.enter="searchList" class="form-control" id="searchText" />
        </div>
        <div class="col-2">
          <input type="button" id="btnSearch" class="btn btn-warning ml-3" value="검색" @click="searchList" :disabled="loadingCount != 0" />
        </div>
        <div class="col-3"></div>
      </div>
      <!-- searchBar end -->
